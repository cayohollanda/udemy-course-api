package br.com.cayohollanda.cursomc.resources.exceptions;
...
import br.com.cayohollanda.cursomc.services.exceptions.FileException;
...
public class ResourceExceptionHandler {
	...
	// Pegando erro dos validadores do Bean Validator
	@ExceptionHandler(MethodArgumentNotValidException.class)
	public ResponseEntity<StandardError> validation(MethodArgumentNotValidException e, HttpServletRequest request) {
		
		ValidationError err = new ValidationError(System.currentTimeMillis(), HttpStatus.UNPROCESSABLE_ENTITY.value(), "Erro de validação", e.getMessage(), request.getRequestURI());
		
		// Indo pegar lista de erros lá no objeto de exceção
